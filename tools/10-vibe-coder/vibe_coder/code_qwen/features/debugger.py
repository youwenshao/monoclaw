"""Bug detection engine using LLM-powered code analysis."""
...
logger = logging.getLogger("vibe-coder.code_qwen.debugger")
...
def _load_system_prompt() -> str:
    ...
    return prompts["debugging"]


class BugDetector:
    """Analyses code for potential bugs, logic errors, and anti-patterns."""
    ...
    async def detect(
        ...
        """Scan code and return a list of detected issues.

        Each issue contains: title, severity, line_hint, description, fix.
        """
    ...
    def _parse_issues(raw: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("Failed to parse debug JSON, returning raw text")
            return [{
